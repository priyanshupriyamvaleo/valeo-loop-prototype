...
export function nextStep(st, pKey) {
  ...
  switch (status) {
    ...
    /* The conviction peak. Results are reviewed, treatment is confirmed, and
       this is where the programme is activated: the balance, with the blood
       test already applied. (Known-door runs never pass through here.) */
    case 'ready': return {
      kind: 'activate', tag: 'Results reviewed',
      title: 'Start your programme.',
      body: `Your treatment is confirmed on your results. Your blood test is `
          + 'already applied toward the cost.',
      cta: 'Start my programme', ctaKind: 'activate',
    };
...
export function practiceScript(st, pKey) {
  ...
  const S = {
    ...
    consulted: {
      ...
      chips: [
        ...
        { ic: '💰', q: 'What does the programme cost?',
          a: ['Your blood test is SAR 499 and it is applied toward the cost '
                + 'of your programme.',
              'The programme balance is only paid when your results are '
                + 'reviewed and your treatment is confirmed.'] },
    ...
    /* The blood test is paid. The next thing the patient does is pick a time. */
    programme: {
      key: 'programme',
      lines: ['Thank you. Your blood test is next, and your SAR 499 is '
                + 'applied toward the cost of your programme.',
              'Pick a time that suits you and a nurse comes to you.'],
      chips: [
        ...
        { ic: '💰', q: 'What do I pay and when?',
          a: ['Your blood test is paid. It is applied toward the cost of your '
                + 'programme.',
              `The balance is only paid when you review your results with `
                + `${first} and your treatment is confirmed.`] },
...
/* ── THE SPLIT (MVP) ──
   ...
   review. One mechanic, one phrase, everywhere it appears: "applied toward
   the cost of your programme." The test fee is a real payment, not a
   discount, so nothing here says save. */
export const TEST_FEE = 499;
export const APPLIED_LINE = 'Applied toward the cost of your programme.';
export function programmeDue(pKey) {
  return carePlan(pKey).price - TEST_FEE;
}

/* The deck's four steps (docs/MVP_LONG_FLOW.md §3.2), shown on the care
   brief. Labels are patient verbs, borrowed shapes: Lifeforce "Start your
   program" and "Retest and refine", Parsley "review the results with your
   provider". */
export function mvpSteps(first) {
  return [
    { t: 'Blood test at home',
      s: `A nurse comes to you. SAR ${TEST_FEE}, applied toward your programme.` },
    { t: 'Review your results',
      s: `A video visit with ${first} to talk through what your results show.` },
    { t: 'Start your programme',
      s: 'Treatment confirmed on your results. Pay the balance only when you start.' },
    { t: 'Retest and refine',
      s: 'Repeat testing at week 12 shows what changed.' },
  ];
}
