 ...
 */
export default function PaySheet({ open, slot, item, fee, note, onClose, onDone }) {
  ...
  return (
    <Drawer anchor="bottom" open={open} onClose={onClose}
      ...
      <Box sx={{ px: 2.5, pt: 2.25, pb: 3.5 }}>
        ...
        {/* One quiet clarity line, e.g. the applied-toward mechanic. */}
        {note && (
          <Typography sx={{ fontSize: 11.5, color: '#8A8A8E', textAlign: 'center', mt: 1.25 }}>
            {note}
          </Typography>
        )}
